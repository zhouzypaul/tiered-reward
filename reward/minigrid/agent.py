...
class MyPPO(PPOAlgo):
    """
    same PPO algo as torch_ac's, just that I modify collect_experiences so that 
    I can log other things.
    """
    ...
    def collect_experiences(self):
        ...
        for i in range(self.num_frames_per_proc):
            ...
            for i, done_ in enumerate(done):
                if done_:
                    ...
                    self.log_original_return.append(self.log_episode_original_return[i].item())
        ...
        logs = {
            ...
            "original_return_per_episode": self.log_original_return[-keep:],
        ...
        self.log_original_return = self.log_original_return[-self.num_procs:]
